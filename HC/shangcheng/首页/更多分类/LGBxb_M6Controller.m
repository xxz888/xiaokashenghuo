...
@interface LGBxb_M6Controller ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation LGBxb_M6Controller


- (void)squallSpontaneityImportune{
...
- (void)viewDidLoad {
    ...
    self.page = 1;
    [self squallSpontaneityImportune];
    [self loadData];
}
