...
+ (UIImage *)consequenceSoporificPlaitRotation:(CIImage *)image size:(CGFloat)size {
...
+ (UIImage *)createQRCodeWithTargetString:(NSString *)targetString logoImage:(UIImage *)logoImage {
    ...
    UIImage *img = [self consequenceSoporificPlaitRotation:image size:[UIScreen mainScreen].bounds.size.width];
