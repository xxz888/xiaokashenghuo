...
@interface CLArcgw_mEController ()<UITableViewDelegate, UITableViewDataSource ,DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>{
    NSInteger ThisPage;
}
...
@implementation CLArcgw_mEController
...
-(void)emptyDataSet:(UIScrollView *)scrollView didTapView:(UIView *)view{
    [self slumpGrowthFrequencyNettle];
}

- (void)slumpGrowthFrequencyNettle{
...
- (UITableView *)tableView{
    if (!_tableView) {
        ...
        _tableView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
            self->ThisPage = 1;
            [weak_self slumpGrowthFrequencyNettle];
